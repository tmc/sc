...
class WebSocketClient extends EventTarget {
    ...
    updateConnectionStatus() {
        ...
        if (window.visualizer && typeof window.visualizer.updateConnectionStatus === 'function') {
            ...
            } else if (this.connectionState === 'connected' && this.clientId) {
                message = `Connected (${this.clientId})`;
            } else if (this.connectionState === 'error') {
                message = `Connection error (${this.reconnectAttempts}/${this.maxReconnectAttempts} attempts)`;
            }
