...
const (
	...
	// Constraints from Eshuis, "Reconciling statechart semantics" (2009).
	RuleId_RECONCILING_C1_NO_COMPLETION_TRANSITIONS                RuleId = 19 // C1: no completion transitions.
	RuleId_RECONCILING_C2_ACYCLIC_TRIGGERING                       RuleId = 20 // C2: no indirect self-triggering.
	RuleId_RECONCILING_C3_NO_EXTERNAL_INTERNAL_CONFLICT            RuleId = 21 // C3: external/internal transitions do not conflict.
	RuleId_RECONCILING_C4_TRIGGERS_ARE_CONSISTENT                  RuleId = 22 // C4: transitions only trigger consistent transitions.
	RuleId_RECONCILING_C5_TOUCHED_INTERNAL_PRECONDITION            RuleId = 23 // C5: touched internal transitions satisfy trigger consistency precondition.
	RuleId_RECONCILING_C6_CONSISTENT_TRIGGERS_STAY_CONSISTENT      RuleId = 24 // C6: triggers of consistent transitions remain consistent.
	RuleId_RECONCILING_C7_NO_COMPLETION_CYCLES                     RuleId = 25 // C7: no cycle of completion transitions.
	RuleId_RECONCILING_C8_NO_COMPLETION_TOUCHES_INTERNAL           RuleId = 26 // C8: completion transitions do not touch internal transitions.
	RuleId_RECONCILING_C9_NO_EXTERNAL_COMPLETION_CONFLICT          RuleId = 27 // C9: external/completion transitions do not conflict.
	RuleId_RECONCILING_C10_NO_COMPLETION_INTERNAL_CONFLICT         RuleId = 28 // C10: completion/internal transitions do not conflict.
	RuleId_RECONCILING_C11_CONFLICTING_COMPLETIONS_SHARE_SOURCES   RuleId = 29 // C11: conflicting completion transitions have same sources.
	RuleId_RECONCILING_C12_ACYCLIC_PREC_RELATION                   RuleId = 30 // C12: precedence relation is acyclic.
	RuleId_RECONCILING_C13_EQUAL_PRIORITY_SHAPE                    RuleId = 31 // C13: conflicting transitions with same trigger have same sources and scope.
	RuleId_RECONCILING_C14_SINGLE_GENERATED_EVENT                  RuleId = 32 // C14: each transition generates at most one event.
	RuleId_RECONCILING_C15_CONSISTENT_SAME_TRIGGER_SAME_OUTPUT     RuleId = 33 // C15: consistent transitions with same trigger generate same event.
	RuleId_RECONCILING_C16_COMPLETION_NOT_CONSISTENT_WITH_INTERNAL RuleId = 34 // C16: completion/internal transitions are inconsistent.
	RuleId_RECONCILING_C17_UML_INTERNAL_PRIORITY                   RuleId = 35 // C17: UML gives internal events priority over external events.
)
...
var (
	RuleId_name = map[int32]string{
		...
		19: "RECONCILING_C1_NO_COMPLETION_TRANSITIONS",
		20: "RECONCILING_C2_ACYCLIC_TRIGGERING",
		21: "RECONCILING_C3_NO_EXTERNAL_INTERNAL_CONFLICT",
		22: "RECONCILING_C4_TRIGGERS_ARE_CONSISTENT",
		23: "RECONCILING_C5_TOUCHED_INTERNAL_PRECONDITION",
		24: "RECONCILING_C6_CONSISTENT_TRIGGERS_STAY_CONSISTENT",
		25: "RECONCILING_C7_NO_COMPLETION_CYCLES",
		26: "RECONCILING_C8_NO_COMPLETION_TOUCHES_INTERNAL",
		27: "RECONCILING_C9_NO_EXTERNAL_COMPLETION_CONFLICT",
		28: "RECONCILING_C10_NO_COMPLETION_INTERNAL_CONFLICT",
		29: "RECONCILING_C11_CONFLICTING_COMPLETIONS_SHARE_SOURCES",
		30: "RECONCILING_C12_ACYCLIC_PREC_RELATION",
		31: "RECONCILING_C13_EQUAL_PRIORITY_SHAPE",
		32: "RECONCILING_C14_SINGLE_GENERATED_EVENT",
		33: "RECONCILING_C15_CONSISTENT_SAME_TRIGGER_SAME_OUTPUT",
		34: "RECONCILING_C16_COMPLETION_NOT_CONSISTENT_WITH_INTERNAL",
		35: "RECONCILING_C17_UML_INTERNAL_PRIORITY",
	}
	RuleId_value = map[string]int32{
		...
		"RECONCILING_C1_NO_COMPLETION_TRANSITIONS":                19,
		"RECONCILING_C2_ACYCLIC_TRIGGERING":                       20,
		"RECONCILING_C3_NO_EXTERNAL_INTERNAL_CONFLICT":            21,
		"RECONCILING_C4_TRIGGERS_ARE_CONSISTENT":                  22,
		"RECONCILING_C5_TOUCHED_INTERNAL_PRECONDITION":            23,
		"RECONCILING_C6_CONSISTENT_TRIGGERS_STAY_CONSISTENT":      24,
		"RECONCILING_C7_NO_COMPLETION_CYCLES":                     25,
		"RECONCILING_C8_NO_COMPLETION_TOUCHES_INTERNAL":           26,
		"RECONCILING_C9_NO_EXTERNAL_COMPLETION_CONFLICT":          27,
		"RECONCILING_C10_NO_COMPLETION_INTERNAL_CONFLICT":         28,
		"RECONCILING_C11_CONFLICTING_COMPLETIONS_SHARE_SOURCES":   29,
		"RECONCILING_C12_ACYCLIC_PREC_RELATION":                   30,
		"RECONCILING_C13_EQUAL_PRIORITY_SHAPE":                    31,
		"RECONCILING_C14_SINGLE_GENERATED_EVENT":                  32,
		"RECONCILING_C15_CONSISTENT_SAME_TRIGGER_SAME_OUTPUT":     33,
		"RECONCILING_C16_COMPLETION_NOT_CONSISTENT_WITH_INTERNAL": 34,
		"RECONCILING_C17_UML_INTERNAL_PRIORITY":                   35,
	}
)
...
const file_validation_v1_validator_proto_rawDesc = "" +
	"\n" +
	"\x1dvalidation/v1/validator.proto\x12\x19statecharts.validation.v1\x1a\x17google/rpc/status.proto\x1a statecharts/v1/statecharts.proto\"\x8e\x01\n" +
	...
	"\x16HISTORY_DEFAULTS_VALID\x10\x12\x12,\n" +
	"(RECONCILING_C1_NO_COMPLETION_TRANSITIONS\x10\x13\x12%\n" +
	"!RECONCILING_C2_ACYCLIC_TRIGGERING\x10\x14\x120\n" +
	",RECONCILING_C3_NO_EXTERNAL_INTERNAL_CONFLICT\x10\x15\x12*\n" +
	"&RECONCILING_C4_TRIGGERS_ARE_CONSISTENT\x10\x16\x120\n" +
	",RECONCILING_C5_TOUCHED_INTERNAL_PRECONDITION\x10\x17\x126\n" +
	"2RECONCILING_C6_CONSISTENT_TRIGGERS_STAY_CONSISTENT\x10\x18\x12'\n" +
	"#RECONCILING_C7_NO_COMPLETION_CYCLES\x10\x19\x121\n" +
	"-RECONCILING_C8_NO_COMPLETION_TOUCHES_INTERNAL\x10\x1a\x122\n" +
	".RECONCILING_C9_NO_EXTERNAL_COMPLETION_CONFLICT\x10\x1b\x123\n" +
	"/RECONCILING_C10_NO_COMPLETION_INTERNAL_CONFLICT\x10\x1c\x129\n" +
	"5RECONCILING_C11_CONFLICTING_COMPLETIONS_SHARE_SOURCES\x10\x1d\x12)\n" +
	"%RECONCILING_C12_ACYCLIC_PREC_RELATION\x10\x1e\x12(\n" +
	"$RECONCILING_C13_EQUAL_PRIORITY_SHAPE\x10\x1f\x12*\n" +
	"&RECONCILING_C14_SINGLE_GENERATED_EVENT\x10 \x127\n" +
	"3RECONCILING_C15_CONSISTENT_SAME_TRIGGER_SAME_OUTPUT\x10!\x12;\n" +
	"7RECONCILING_C16_COMPLETION_NOT_CONSISTENT_WITH_INTERNAL\x10\"\x12)\n" +
	"%RECONCILING_C17_UML_INTERNAL_PRIORITY\x10#2\xfb\x01\n" +
	...
	"\rValidateTrace\x12/.statecharts.validation.v1.ValidateTraceRequest\x1a0.statecharts.validation.v1.ValidateTraceResponseB2Z0github.com/tmc/sc/gen/validation/v1;validationv1b\x06proto3"
