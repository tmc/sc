...
class Statechart(_message.Message):
    __slots__ = ("root_state", "transitions", "events", "variables", "name", "description")
...
class State(_message.Message):
    __slots__ = ("label", "type", "children", "is_initial", "is_final", "entry_actions", "exit_actions")
    ...
    def __init__(self, label: _Optional[str] = ..., type: _Optional[_Union[StateType, str]] = ..., children: _Optional[_Iterable[_Union[State, _Mapping]]] = ..., is_initial: bool = ..., is_final: bool = ..., entry_actions: _Optional[_Iterable[_Union[Action, _Mapping]]] = ..., exit_actions: _Optional[_Iterable[_Union[Action, _Mapping]]] = ...) -> None: ...

class Transition(_message.Message):
    __slots__ = ("label", "to", "event", "guard", "actions", "priority")
    LABEL_FIELD_NUMBER: _ClassVar[int]
    ...
    priority: int
    def __init__(self, label: _Optional[str] = ..., to: _Optional[_Iterable[str]] = ..., event: _Optional[str] = ..., guard: _Optional[_Union[Guard, _Mapping]] = ..., actions: _Optional[_Iterable[_Union[Action, _Mapping]]] = ..., priority: _Optional[int] = ..., **kwargs) -> None: ...

class Event(_message.Message):
    __slots__ = ("label", "parameters")
    LABEL_FIELD_NUMBER: _ClassVar[int]
...
class Guard(_message.Message):
    __slots__ = ("expression", "language")
    EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    LANGUAGE_FIELD_NUMBER: _ClassVar[int]
    expression: str
    language: str
    def __init__(self, expression: _Optional[str] = ..., language: _Optional[str] = ...) -> None: ...

class Action(_message.Message):
    __slots__ = ("label", "expression", "language", "parameters")
    LABEL_FIELD_NUMBER: _ClassVar[int]
    EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    LANGUAGE_FIELD_NUMBER: _ClassVar[int]
    PARAMETERS_FIELD_NUMBER: _ClassVar[int]
    ...
    language: str
    parameters: _struct_pb2.Struct
    def __init__(self, label: _Optional[str] = ..., expression: _Optional[str] = ..., language: _Optional[str] = ..., parameters: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class Machine(_message.Message):
    __slots__ = ("id", "state", "context", "statechart", "configuration", "step_history")
...
class Step(_message.Message):
    __slots__ = ("events", "transitions", "starting_configuration", "resulting_configuration", "context", "states_entered", "states_exited", "actions_executed")
    EVENTS_FIELD_NUMBER: _ClassVar[int]
    TRANSITIONS_FIELD_NUMBER: _ClassVar[int]
